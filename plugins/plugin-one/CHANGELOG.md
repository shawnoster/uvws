...
- **plugin-one**: Correct error message for missing apiToken in evaluate method
  ([`8895e88`](https://github.com/shawnoster/uvws/commit/8895e88053be7b7df52d7309c2bbc88213f772e0))

### Features

- **plugin-one**: Add PluginInvalidCredentials for missing serviceName in evaluate method
  ([`7331b65`](https://github.com/shawnoster/uvws/commit/7331b6561cf049227ee790e444b941ff37c72bf5))
